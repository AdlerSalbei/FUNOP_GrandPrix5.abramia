...
private _uniform = player getVariable ["grad_grandprix_gog_playerUniform","U_Marshal"];
...
private _radio = player getVariable ["grad_grandprix_gog_radioInstance","TFAR_anprc152"];
