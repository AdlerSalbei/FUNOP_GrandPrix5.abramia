...
// ["x\grad_grandprix5\addons\sounds\data\PUPS_Description.ogg", _target, false, (getPosASL _target vectorAdd [0,0,1.6]), 100, 1, 60] remoteExec ["playSound3D", 2, false];
private _players = units (group _player);
["PUPS_Description"] remoteExecCall ["playSound", _players + [[_target] call grad_grandprix_fnc_common_getNearestZeus]];
